import { useGetDashboardMetricsQuery, ExpenseByCategorySummary, useGetExpensesByCategoryQuery } from "@/state/api"
                ...
                {expenseSummary && (
                    <div className="mt-3 flex justify-between items-center px-7 mb-4">
                        <div className="pt-2">
                            <p className="text-sm">
                                Average: {" "}
                                <span className="font-semibold">S/{expenseSummary.totalExpenses.toFixed(2)}</span>
                            </p>
                        </div>
